**Hi, this is a beginner project for Arduino Uno, it's basically a thermometer with other functions like fire detection and other that will be implemented.**
